...
function Checkout({ cart, clearCart, updateQuantity }) {
  ...
  const SHOP_UPI_ID = "9059907938@ybl"; // Updated UPI ID
      ...
      {showPaymentModal && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 text-center space-y-4 shadow-xl border animate-fade-in">
            <h3 className="text-xl font-black text-gray-900">Click to Pay</h3>
            ...
            <div className="space-y-2">
              <a href={upiString} className="block w-full bg-blue-600 text-white text-sm font-bold py-3 rounded-xl hover:bg-blue-700 transition-colors shadow-sm mt-4 mb-4">
                📱 Open Payment App
              </a>
            </div>
